...
public class Graphic {
	...
	public static void init(Stage stage) {
		...
		graphic.setScene(new Scene(group, 900, 520));
	...
	public static VBox createChart(ArrayList<XY> list1, String name1) {
		list = list1;
		name = name1;
		...
		chart.setMinSize(850, 310);
		chart.setMaxSize(850, 310);
